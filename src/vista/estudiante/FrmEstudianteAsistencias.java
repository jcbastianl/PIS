...
public class FrmEstudianteAsistencias extends javax.swing.JFrame {
    ...
    public FrmEstudianteAsistencias(Integer cursa, String asignatura) {
        initComponents();
        aux.reset();
        this.estudiante = cursa;
        cargarTabla();
        lblAsignatura.setText(asignatura);
    }

    private void cargarTabla() {
        modelo.setAsistencias(asistenciaControl.all());
        modelo.setEstu(estudiante);
    ...
    @SuppressWarnings("unchecked")
        ...
        private void initComponents() {
                ...
                tblAsistencias.setEnabled(false);
                jScrollPane1.setViewportView(tblAsistencias);

                jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 210, 910, 490));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmEstudianteAsistencias(null, null).setVisible(true);
            }
        });
    }
